      ...
      <StatusBar style={"light"}/>
        ...
        <View className="w-full absolute flex-row justify-between items-center pt-14">
            <TouchableOpacity onPress={()=>navigation.goBack()} className="p-2 rounded-full ml-5 bg-white">
                <ChevronLeftIcon size={hp(3.5)} strokeWidth={4.5} color="#111111"/>
            </TouchableOpacity>
        ...
        {
            loading? (
                <Loading size="large" className="16"/>
            ):(
                <View className="px-4 flex justify-between space-y-4 pt-8">
                    <View className="space-y-2">
                        ...
                        <Text style={{fontSize: hp(2)}} className=" font-medium flex-1 text-neutral-700">
                            {meal?.strArea}
                        </Text>
                    </View>
                    ...
                    {/**Video */}
                    {
                        meal.strYoutube && (
                            <View className="space-y-4">
                                <Text style={{fontSize:hp(2.5)}} className="font-bold flex-1 text-neutral-700">Recipe Vido</Text>    
                                <View>
